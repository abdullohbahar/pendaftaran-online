    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.update.regulasi', $regulasi->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_dokumen" id=""
                                            required value="{{ $regulasi->nama_dokumen }}">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        <label for="">Tahun Terbit</label>
                                        <input type="number" value="{{ $regulasi->tahun_terbit }}" class="form-control"
                                            name="tahun_terbit" id="" required maxlength="4"
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $regulasi->jenis }}"
                                            name="jenis" id="" required>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        <label>File <i style="color: red">Kosongkan jika tidak ingin mengubah
                                                file</i></label>
