                ...
                <div class="row">
                    <div
                        ...
                        {{-- <div class="login-brand">
                            <img src="../logo/logo-lksa.jpg" alt="logo" width="160"
                                ...
                                <form method="POST" action="{{ route('auth') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="username" type="username"
                                            ...
                                            tabindex="1" autofocus value="{{ old('username', session('username')) }}">
                                        @error('username')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password"
                                            ...
                                            name="password" tabindex="2" autocomplete="new-password">
                                        @error('password')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
