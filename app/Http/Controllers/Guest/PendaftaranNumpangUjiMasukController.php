...
class PendaftaranNumpangUjiMasukController extends Controller
{
    public function index()
    {
        $jenis = Klasifikasi::orderBy('klasifikasis', 'asc')->get();
        $daerah = KodeWilayah::orderBy('namawilayah', 'asc')->get();
        ...
        return view('guest.registration.numpang-uji-masuk', $data);
    }
